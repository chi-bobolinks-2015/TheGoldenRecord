...
Track.create(title: "Beach", artist: "Roy Wood$", description: "A one of a kind recording of a storm in space. You may think it sounds a lot like an earth storm, but that's really just your opinion.", category_id: 1, url: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/216772566", length: nil, composer: nil)
