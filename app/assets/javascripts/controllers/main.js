...
someMix.addTrack({'urls': 'https://s3.amazonaws.com/the-golden-record/music/ReginaApp-+Swing.mp3', 'divId': 0})
...
var delay = new tuna.Delay({
    feedback: .5,    //0 to 1+
    delayTime: 1000,    //how many milliseconds should the wet signal be delayed?
    wetLevel: 5,    //0 to 1+
    dryLevel: 1,       //0 to 1+
    cutoff: 2000,      //cutoff frequency of the built in lowpass-filter. 20 to 22050
    bypass: 0
